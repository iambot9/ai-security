...
**Prerequisites:** LAB3A complete (custom defenses built)
...
def scan_output(prompt: str, response: str) -> ScanResult:
    """
    ...
    try:
        sanitized_response, results, is_valid = scan_output(
...
```python
from defenses.llm_guard_scanner import scan_input as llm_guard_input, scan_output as llm_guard_output
```
...
from defenses.llm_guard_scanner import (                       # LAB3B Part 1
    ...
    scan_output as llm_guard_scan_output,
)
...
*Next: LAB4 — Agentic Security: Tool Call Interception and Multi-Agent Trust Boundaries.*
